...
To apply the patch, change the vcsRoot with id = 'HttpsGithubComOllvenSubmodulesRefsHeadsMain1'
accordingly, and delete the patch script.
*/
changeVcsRoot(RelativeId("HttpsGithubComOllvenSubmodulesRefsHeadsMain1")) {
